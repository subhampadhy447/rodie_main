...
const data = [
  {
    name: "kedarnath",
    description:
      "Kedarnath is the most remote of the four Chota Char Dham pilgrimage sites. It is located in the Himalayas, about 3,583 m (11,755 ft) above sea level near the Chorabari Glacier, which is the source of the Mandakini river. The town is flanked by snow-capped pea and covered with snow .",
    imageWide:
      "kedarnathpic.jpg",
    imageTall:
      "k_pic3.jpg",
    ...
    facts: [
      ...
      " One of the most important temples of Sanatan Dharma (Hinduism) the Kedarnath temple shrine is situated in the high altitude said to have been constructed there by the Pandavas of Mahabharata who were seeking pardon for the ills and sins that get written to one's accounts due to practices such as war. The Pandavas travelled to Kashi in search of Lord Shiva after the great war of Kurukshetra and Bhole Shankar being the God he is, escaped to Uttarakhand by transfiguring himself in the form of a bull. Pandavas learnt of this and travelled from Kashi to Uttarakhand. Soon they found Lord Shiva in his Bull form and begin to pray. They say Guptakashi is the place where Pandavas found Shiva as the bull - who soon granted them blessings. They say the shrine's origins may be in Mahabharat but the current temple was designed and constructed under the orders of Adi Shankaracharya. ",
  ...
  {
    name: "Jagarnath Temple",
    description:
      "Puri's Jagannath Temple located in Odisha. The temple is of utmost importance to the Hindu devotees as it is one of the Char-Dham Pilgrimages. The temple is famous for its annual Rath Yatra which is witnessed by millions as the three colossal chariots carry the deities. The English word Juggernaut shares its origin from this annual parade",
    imageWide:
      "p_pic1.jpg",
    imageTall:
      "p_pic.jpg",
    ...
    image2:
      ...
      "p_pic3.jpg",
    facts: [
      " The flag mounted on the top of the Jagannath Temple is a unique exception to the principle. This particular flag flows in the opposite direction to the wind's course without any scientific background to back it up.",
      ...
      "In Hindu mythology, wasting food is considered a bad sign the Temple crew follows the same.  A total number of people visiting the temple varies between 2,000 to 2, 00,000 people every day. Miraculously, the Parsadam prepared every day is never wasted not even a bite. Could this be an effective management or the Lords will",
    ],
  },
...

  {
    name: "Rameswaranm",
    description:
      "Ramanathaswamy Temple is a Hindu temple dedicated to the god Shiva. It is located on Rameshwaram, on the eastern side of Pamban Island, in the state of Tamil Nadu, India. The temple is a holy site of immense importance for Hindus that attracts millions of pilgrims and massive devotees every year, especially during the festival of Maha Shivaratri.",
    imageWide:
      "r_pic.jpg",
    imageTall:
      "r_pic2.jpeg",
    ...
    facts: [
      ...
      "The legend goes by that Rama wanted to have a large Lingam to worship Shiva to absolve him of the sin of killing a Brahmin. Thus, he directed Hanuman, (the monkey lieutenant in his army) to bring a Lingam from the Himalayas. However, when Hanuman was delayed in bringing the Lingam. Ensured by the event, Devi Sita, the wife of Rama, built a small Lingam out of the sand that was available on the seashore. Thus Both the Lingam was then installed by Lord Rama.",
      "The temple tanks hall of 1212 pillars in the outer corridor, whose height is about 30 feet from the floor to the center of the roof. The main tower or Rajagopuram is 53 m tall",
    ],
  },
...

  {
    name: "Mysore Palace",
    description:
      "The Mysore Palace, also known as Amba Vilas Palace, is a historical palace and a royal residence (house). It is located in Mysore, Karnataka. It used to be the official residence of the Wadiyar dynasty and the seat of the Kingdom of Mysore. The palace is in the centre of Mysore, and faces the Chamundi Hills",
    imageWide:
      "m_pic1.jpg",
    imageTall:
      "m_pic.jpg",
    ...
    image2:
      "m_pic3.jpg",
    facts: [
      "The Mysore Palace (also known as the Amba Vilas Palace) is touted to be the second most-visited tourist attraction in the country (after the iconic Taj Mahal). While the landmark structure gets visitors throughout the year, this goes up exponentially during Dasara. ",
      "Before the present version came into being, the palace was entirely built of wood! The new palace was commissioned after the structure burned down sometime in the late 1890's (supposedly during the Dasara festivities). ",
      " The last palace, now known as the Old Palace or the Wooden Palace, burned to ashes during a wedding in 1896. Maharaja Krishnaraja Wodeyar IV and his mother Maharani Kempananjammanni Devi commissioned the British architect Henry Irwin to build a new palace.[2",
      " The light and sound show held in the evenings is one of the prime attractions at Mysore Palace. The entire show portrays the 600-year-old cultural heritage, history, and traditions of the Wodeyar Dynasty in a visually appealing manner.Duration: 45 minutesTimings:  7.00 pm to 08.00 pm; all days except Sundays and public holidaysTickets: ₹ 70 for adults; ₹ 30 for kids above 7 years and below 12 years",
    ],
  },
